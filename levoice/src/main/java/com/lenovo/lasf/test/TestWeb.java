...
public class TestWeb extends Activity {
	...
	private void start() {
		...
		recognizerIntent.putExtra("speech_domain", "was"); // 识别联系人领域
	...
	private void startmu() {
		...
		Intent recognizerIntent = new Intent();
		recognizerIntent.putExtra("<main>", new String[] { "呼叫<name>",
				"<name>", "打电话给<name>","打开<apps>","<apps>","<was>网","<was>","<vod>" });
...
//		Log.i("本机程序", ""+apps.toString());
	...
	private void openApp(String packageName) {
		PackageManager packageManager = TestWeb.this.getPackageManager();
